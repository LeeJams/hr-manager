        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between py-2 border-b border-gray-100">
              ...
              <span className="text-sm font-medium text-dark">
                {formatGender(profile.personalInfo.gender)}
              </span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-100">
              ...
              >
                ...
                <div className="space-y-1 text-sm">
                  <p className="text-gray-600">
                    <span className="font-medium">투입기간:</span>{" "}
                  ...
                  <p className="text-gray-600">
                    <span className="font-medium">업무내용:</span>{" "}
                    {career.duties}
                  </p>
                </div>
              </div>
            ...
            {profile.projectCareer.map((project) => (
              ...
              >
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p className="text-gray-600">
                    <span className="font-medium">담당업무:</span>{" "}
          ...
          <div className="space-y-4">
            {profile.certificates.map((cert) => (
              ...
              >
                ...
                <div className="space-y-1 text-sm">
                  <p className="text-gray-600">
                    <span className="font-medium">취득일:</span>{" "}
            ...
            {profile.education.map((edu) => (
              ...
              >
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p className="text-gray-600">
                    <span className="font-medium">졸업구분:</span>{" "}
                    {formatGraduationStatus(edu.status)}
                  </p>
                  <p className="text-gray-600">
                    <span className="font-medium">재학기간:</span>{" "}
