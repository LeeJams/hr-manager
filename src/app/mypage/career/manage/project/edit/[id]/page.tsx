...
export default function EditProjectCareerPage() {
  ...
  const [formData, setFormData] = useState<Omit<ProjectCareer, 'createdAt' | 'updatedAt'>>({
    id: '',
    projectName: '',
    clientName: '',
    startDate: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Updating project career:', submitData)
      await new Promise((resolve) => setTimeout(resolve, 1000)) // Mock delay

      alert('프로젝트 경력이 수정되었습니다.')
